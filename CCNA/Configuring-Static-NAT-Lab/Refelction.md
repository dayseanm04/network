...
- After configuring Static NAT on the router, internal hosts were able to successfully communicate with public destinations like **8.8.8.8** and **google.com**. :contentReference[oaicite:0]{index=0}
