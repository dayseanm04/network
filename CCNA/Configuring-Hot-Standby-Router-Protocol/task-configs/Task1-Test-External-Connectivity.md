# Task1 Test External Connectivity 🧪🌍

## 🎯 Goal
Ping the external server **8.8.8.8** from **PC1** and **PC2**, then identify the **default gateway** currently configured on each PC. :contentReference[oaicite:0]{index=0}
