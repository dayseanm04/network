# Download **VMware Workstation Pro on Windows or Linux**
...
<br /><br />
Click on the **windows version**. (this GNS3 setup is for windows but you can download the linux version if you are using linux) <br /> </br />
