...
Give the Internal internal an IP addresss, Subnet Mask, Default Gateway and the DHCP Server. Note the default gateway and the DHCP Server is the SVI of VLAN 300.
